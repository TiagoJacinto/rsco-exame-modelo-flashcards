...
import { ChevronLeft, ChevronRight, RotateCcw, Lightbulb, HelpCircle, ImageIcon } from "lucide-react"
    ...
    <main className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-4xl mx-auto">
            ...
            >
              <CardContent className="p-8 h-full flex flex-col">
                ...
                <div className="flex-1 flex items-center justify-center">
                  <p className="text-xl text-foreground text-center leading-relaxed">{currentCard.question}</p>
                </div>
                <p className="text-center text-muted-foreground text-sm mt-4">Clica para ver a resposta</p>
              </CardContent>
            </Card>
            ...
            >
              <CardContent className="p-8 h-full flex flex-col overflow-y-auto">
                ...
                <div className="flex-1">
                  <div className="text-foreground leading-relaxed whitespace-pre-line">{currentCard.answer}</div>
                </div>
                <p className="text-center text-muted-foreground text-sm mt-4">Clica para voltar à pergunta</p>
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          <Button variant="outline" onClick={handlePrev} disabled={currentIndex === 0} className="gap-2 bg-transparent">
        ...
        <div className="mt-8">
          <h3 className="text-sm font-medium text-muted-foreground mb-3 text-center">Navegar por questão</h3>
